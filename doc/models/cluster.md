...
|  --- | --- | --- | --- |
| `apiVersion` | `string \| undefined` | Optional | - |
| `kind` | `string \| undefined` | Optional | - |
| `metadata` | [`Metadata \| undefined`](../../doc/models/metadata.md) | Optional | - |
| `spec` | [`ClusterSpec \| undefined`](../../doc/models/cluster-spec.md) | Optional | - |
| `status` | [`ClusterStatus \| undefined`](../../doc/models/cluster-status.md) | Optional | - |
