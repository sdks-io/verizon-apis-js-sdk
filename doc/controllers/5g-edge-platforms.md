...
```ts
async listMECPlatforms(  region?: string,
  serviceProfileId?: string,
  subscriberDensity?: number,
  uEIdentityType?: UserEquipmentIdentityTypeEnum,
  uEIdentity?: string,
requestOptions?: RequestOptions): Promise<ApiResponse<ListMECPlatformsResult>>
```
...
```ts
async listRegions(requestOptions?: RequestOptions): Promise<ApiResponse<ListRegionsResult>>
```
