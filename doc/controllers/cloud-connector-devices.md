...
```ts
const cloudConnectorDevicesController = new CloudConnectorDevicesController(client);
```
...
try {
  const { result, ...httpResponse } = await cloudConnectorDevicesController.updateDevicesConfigurationValue(body);
...
try {
  const { result, ...httpResponse } = await cloudConnectorDevicesController.findDeviceByPropertyValues(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
try {
  const { result, ...httpResponse } = await cloudConnectorDevicesController.searchDevicesResourcesByPropertyValues(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
try {
  const { result, ...httpResponse } = await cloudConnectorDevicesController.searchDeviceEventHistory(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
try {
  const { result, ...httpResponse } = await cloudConnectorDevicesController.searchSensorReadings(
    fieldname,
    body
  );
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await cloudConnectorDevicesController.deleteDeviceFromAccount(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
